...
class Ruecksetzpunktverwalter extends Node {
	...
	public String runNode(String input) throws SoFTException {
		 ...
		 * Es wird eine Fehlermeldung (Nachrichtentyp �f�)  von dem  R�cksetzpunktverwalter C mit dem Inhalt "<f> + Fehlermeldung" empfangen, wobei
			...
			R�cksetzpunkten wird f�r alle nicht verf�gbaren Elemente von a der Wert �1 eingetragen. Wenn der
			R�cksetzpunkt-Speicher RP voll ist und ein weiterer R�cksetzpunkt gespeichert werden soll, muss der
			mit Index 1 abgespeicherte R�cksetzpunkt RP[1][...] aus RP gel�scht werden. Alle nachfolgenden
...
public class G06_A2 extends SoFT {
	...
	public int result(String input, String[] output) {
		...
		if (b < 60 || b > 81)
			return 2; // Zu geringer/gro�er Fortschritt.
		if (a < b)
